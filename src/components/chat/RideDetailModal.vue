...
<template>
    ...
    <div v-if="isOpen"
        ...
        <div class="bg-white w-full max-w-[580px] max-h-[85vh] rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden animate-slide-up"
            ...
            <div v-else-if="rideInfo" class="overflow-y-auto custom-scroll p-6 space-y-6 bg-slate-50/50 flex-1">
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <div class="relative pl-2 space-y-8">
                        ...
                        <div class="relative flex gap-4">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400">{{ rideInfo.route.startTime }} 출발 예정</p>
                        ...
                        <div class="relative flex gap-4">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-400">{{ rideInfo.route.endTime }} 도착 예정</p>
                ...
                <div class="bg-indigo-50/50 p-6 rounded-3xl border border-indigo-100">
                    ...
                    <div class="flex justify-between items-end border-b border-indigo-100/50 pb-4 mb-4">
                        ...
                        <span class="text-slate-900 font-bold">{{ rideInfo.payment.total.toLocaleString() }}원</span>
                    </div>
                    <div class="flex justify-between items-end">
                        <span class="text-slate-500 text-sm">나의 부담금 (1/4)</span>
                        <span class="text-2xl font-black text-indigo-600">{{ rideInfo.payment.mine.toLocaleString() }}원</span>
                    </div>
                </div>
            </div>
