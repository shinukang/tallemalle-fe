        ...
        <div class="bg-white w-full max-w-md rounded-[24px] shadow-xl overflow-hidden relative border border-white/50">
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button type="button" @click="loginWithGoogle"
                            ...
                            <img src="https://fonts.gstatic.com/s/i/productlogos/googleg/v6/24px.svg" class="w-4 h-4"
                                alt="Google">
            ...
            <div class="p-8 pt-4 text-center">
                <p class="text-sm text-slate-500">
                    아직 회원이 아니신가요?
                    <router-link to="/signup" class="text-indigo-600 font-bold hover:underline ml-1">회원가입</router-link>
                </p>
            </div>
        </div>
    </div>
